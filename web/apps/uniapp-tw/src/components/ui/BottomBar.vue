...
<template>
  <view
    ...
    <Button size="lg" variant="secondary" class="flex-1 !rounded-md" @click="emit('add-record')">
      添加到记录
    </Button>

    <Button size="lg" variant="default" class="flex-1 !rounded-md !text-white" @click="emit('chat')">
      咨询 AI 助手
    </Button>
  </view>
</template>
