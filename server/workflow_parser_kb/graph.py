...
from workflow_parser_kb.models import ParserResult, WorkflowState
...
async def run_parser_workflow(
    ...
    with _tracer.start_as_current_span("parser_workflow") as root_span:
        root_span.set_attribute("workflow_parser_kb.doc_id", doc_metadata.get("doc_id", ""))
        ...
        root_span.set_attribute("workflow_parser_kb.doc_type", doc_type)
...
async def run_parser_workflow_stream(
    ...
    root_span = _tracer.start_span("parser_workflow_stream")
    root_span.set_attribute("workflow_parser_kb.doc_id", doc_id)
    try:
